         ...
         <div class="row align-items-center">
            ...
            <div class="col-lg-6 ms-0 ms-lg-auto d-none d-lg-block">
               <div class="comments__box">
                  <div class="comment__card comment__card--purple mx-auto comment__card--animation">
                     <div class="comment__photo">
                        <img class="comment__image" src="./assets/img/comment-image-1.jpg" alt="Chack">
                     </div>
                  ...
                  <div class="d-flex align-items-center mb-5">
                     <img src="/assets/img/trust.svg" alt="trust" width="180" height="94">
                     <div class="comment__card comment__card--orange ms-auto me-4 mb-0 comment__card--animation comment__card--animation_reverse">
                        <div class="comment__photo">
                           <img class="comment__image" src="./assets/img/comment-image-2.jpg" alt="Inna">
                        </div>
                        <p class="comment__text">
                  ...
                  <div class="comment__card comment__card--green comment__card--animation mx-auto">
                     <div class="comment__photo">
                        <img class="comment__image" src="./assets/img/comment-image-3.jpg" alt="Chack">
                     </div>
                     <p class="comment__text">
