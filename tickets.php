         ...
         <div class="card shadow-m p-0 overflow-hidden">
            <div class="card-header border-0 d-block d-md-flex align-items-center">
               <nav class="me-auto d-flex text-center">
                  <a href="/tickets.php" class="me-3 me-sm-4 link-active">Recent</a>
                  <a href="/tickets.php" class="flex-align-center fw-medium me-3 me-sm-4"><i class="fa-solid fa-circle color-u-orange fs-10 me-2"></i>Open</a>
                  <a href="/tickets.php" class="flex-align-center fw-medium"><i class="fa-solid fa-circle color-green fs-10 me-2"></i>Closed</a>
               </nav>
